...
const Fields2Form = (props) => {
  const onSubmit = (data) => {
    props.onSave(data, props?.fields2?.id)
  }
  ...
  return (
    <div className="rw-form-wrapper">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        <TextField
          name="field1"
          defaultValue={props.fields2?.field1}
          className="rw-input"
        ...
        <TextField
          name="field2"
          defaultValue={props.fields2?.field2}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field3"
          defaultValue={props.fields2?.field3}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field4"
          defaultValue={props.fields2?.field4}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field5"
          defaultValue={props.fields2?.field5}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field6"
          defaultValue={props.fields2?.field6}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field7"
          defaultValue={props.fields2?.field7}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field8"
          defaultValue={props.fields2?.field8}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field9"
          defaultValue={props.fields2?.field9}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field10"
          defaultValue={props.fields2?.field10}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field11"
          defaultValue={props.fields2?.field11}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field12"
          defaultValue={props.fields2?.field12}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field13"
          defaultValue={props.fields2?.field13}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field14"
          defaultValue={props.fields2?.field14}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field15"
          defaultValue={props.fields2?.field15}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="fields2Id"
          defaultValue={props.fields2?.fields2Id}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />

        <FieldError name="fields2Id" className="rw-field-error" />
