...
const Fields4Form = (props) => {
  const onSubmit = (data) => {
    props.onSave(data, props?.fields4?.id)
  }
  ...
  return (
    <div className="rw-form-wrapper">
      <Form onSubmit={onSubmit} error={props.error}>
        ...
        <TextField
          name="field1"
          defaultValue={props.fields4?.field1}
          className="rw-input"
        ...
        <TextField
          name="field2"
          defaultValue={props.fields4?.field2}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field3"
          defaultValue={props.fields4?.field3}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field4"
          defaultValue={props.fields4?.field4}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field5"
          defaultValue={props.fields4?.field5}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field6"
          defaultValue={props.fields4?.field6}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field7"
          defaultValue={props.fields4?.field7}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field8"
          defaultValue={props.fields4?.field8}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field9"
          defaultValue={props.fields4?.field9}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field10"
          defaultValue={props.fields4?.field10}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field11"
          defaultValue={props.fields4?.field11}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field12"
          defaultValue={props.fields4?.field12}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field13"
          defaultValue={props.fields4?.field13}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field14"
          defaultValue={props.fields4?.field14}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="field15"
          defaultValue={props.fields4?.field15}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />
        ...
        <TextField
          name="fields4Id"
          defaultValue={props.fields4?.fields4Id}
          className="rw-input"
          errorClassName="rw-input rw-input-error"
          validation={{ required: true }}
        />

        <FieldError name="fields4Id" className="rw-field-error" />
