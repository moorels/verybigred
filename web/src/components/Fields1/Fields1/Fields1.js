      ...
      <div className="rw-segment">
        ...
        <table className="rw-table">
          <tbody>
            ...
            <tr>
              <th>Field1</th>
              <td>{fields1.field1}</td>
            </tr>
            <tr>
              <th>Field2</th>
              <td>{fields1.field2}</td>
            </tr>
            <tr>
              <th>Field3</th>
              <td>{fields1.field3}</td>
            </tr>
            <tr>
              <th>Field4</th>
              <td>{fields1.field4}</td>
            </tr>
            <tr>
              <th>Field5</th>
              <td>{fields1.field5}</td>
            </tr>
            <tr>
              <th>Field6</th>
              <td>{fields1.field6}</td>
            </tr>
            <tr>
              <th>Field7</th>
              <td>{fields1.field7}</td>
            </tr>
            <tr>
              <th>Field8</th>
              <td>{fields1.field8}</td>
            </tr>
            <tr>
              <th>Field9</th>
              <td>{fields1.field9}</td>
            </tr>
            <tr>
              <th>Field10</th>
              <td>{fields1.field10}</td>
            </tr>
            <tr>
              <th>Field11</th>
              <td>{fields1.field11}</td>
            </tr>
            <tr>
              <th>Field12</th>
              <td>{fields1.field12}</td>
            </tr>
            <tr>
              <th>Field13</th>
              <td>{fields1.field13}</td>
            </tr>
            <tr>
              <th>Field14</th>
              <td>{fields1.field14}</td>
            </tr>
            <tr>
              <th>Field15</th>
              <td>{fields1.field15}</td>
            </tr>
            <tr>
              <th>Fields1 id</th>
              <td>{fields1.fields1Id}</td>
            </tr>
          </tbody>
        </table>
      </div>
